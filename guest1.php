...
$text="One of the best digital marketing software in the market.One of the best digital marketing software in the market.";
 ...
 imagettftext($new, 10, 0, 110, 280, $text_color, $font2, $newtext);
 }else{
	 $newtext = wordwrap($text2, 30, " \n");  
 imagettftext($new, 8, 0, 120, 280, $text_color, $font2, $newtext);
 }
  imagettftext($new, 28, 0, 70, 230, $text_color, $font1, "Ashutosh Tiwari");
   imagettftext($new, 18, 0, 140, 460, $text_color, $font1, "Contact Us");
    imagettftext($new, 10, 0, 150, 500, $text_color, $font1, "+91 9004925237");
echo  $newtext;
    // Save the picture
 
        imagejpeg($new, $public_file_path . '/guest1.jpg', 100); 
    imagedestroy($new); 
 }
 ?>