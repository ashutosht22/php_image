...
$text_color1=imagecolorallocate($new, 255,255,255);
   $texth=$upbarh/3;
   echo $texth;
  //echo (14*$h)/15;
     //facebook url height formula (Height-(Height/34))
//	   imagettftext($new, 30, 0, 230, 160, $text_color1, $font2,"WEAR YOURSELF OUT");
 ...
 $text="ALL PROGRESS TAKES PLACE OUTSIDE THE COMFORT ZONE.";
  ...
  $text1 = substr($text, 0, 250);
   ...
   $text2 = substr($text, 0, $dot+1);
    $newtext = wordwrap($text2, 15, " \n");
    echo  $newtext;
 $text_color = imagecolorallocate($new, $textcolorR,$textcolorG,$textcolorB);
//ImageRectangle($new, $r_x, $r_y, $r_x+$r_width, $r_y+$r_height, $black);

imagettftext($new, 68, 0, 206, 390, $text_color, $font2, $newtext);
    ...
    // Save the picture
        ...
        imagejpeg($new, $public_file_path . '/designv23.jpg', 100); 
    imagedestroy($new); 
 }
 ?>